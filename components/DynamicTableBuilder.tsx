      ...
      <div className="bg-white border border-border-custom rounded-lg p-6 shadow-sm">
        <div className="text-center py-8">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-4">
            <button
              onClick={() => addTableFromTemplate('vacancy')}
              className="bg-primary hover:bg-[#600000] text-white px-3 py-2 rounded text-xs font-bold"
            >
              Vacancy Details
            </button>
            <button
              onClick={() => addTableFromTemplate('fee')}
              className="bg-primary hover:bg-[#600000] text-white px-3 py-2 rounded text-xs font-bold"
            >
              Application Fee
            </button>
            <button
              onClick={() => addTableFromTemplate('ageLimit')}
              className="bg-primary hover:bg-[#600000] text-white px-3 py-2 rounded text-xs font-bold"
            >
              Age Limit
            </button>
            <button
              onClick={() => addTableFromTemplate('cutoff')}
              className="bg-primary hover:bg-[#600000] text-white px-3 py-2 rounded text-xs font-bold"
            >
              Cutoff Marks
            </button>
            <button
              onClick={() => addTableFromTemplate('examPattern')}
              className="bg-primary hover:bg-[#600000] text-white px-3 py-2 rounded text-xs font-bold"
            >
              Exam Pattern
            </button>
            <button
              onClick={() => addTableFromTemplate('salary')}
              className="bg-primary hover:bg-[#600000] text-white px-3 py-2 rounded text-xs font-bold"
            >
              Salary Structure
            </button>
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={addCustomTable}
          className="bg-primary hover:bg-[#600000] text-white px-3 py-1.5 rounded text-xs font-bold flex items-center space-x-1"
        >
              ...
              <thead>
                <tr>
                  {table.columns.map((column, colIndex) => (
                    <th key={colIndex} className="bg-secondary text-white px-2 py-2 border border-border-custom">
                      <div className="flex items-center space-x-1">
