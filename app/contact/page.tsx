  ...
  return (
    <div className="bg-white border border-border-custom rounded-lg p-6 md:p-8 shadow-sm space-y-6 max-w-3xl mx-auto text-xs sm:text-sm text-gray-600">
      ...
      <p className="leading-relaxed">
        For advertising inquiries, content corrections, or copyright/DMCA issues, please contact the JobJanta desk. We make every effort to respond to emails within 24-48 business hours.
      </p>
      ...
      <div className="flex items-center space-x-3 bg-gray-50 border border-gray-150 p-4 rounded-md">
        ...
        <div>
          ...
          <p className="text-primary font-semibold">support@jobjanta.com</p>
        </div>
      </div>
