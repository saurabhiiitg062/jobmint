...
export default function PrivacyPolicyPage() {
  return (
    <div className="bg-white border border-border-custom rounded-lg p-6 md:p-8 shadow-sm space-y-4 max-w-3xl mx-auto text-xs sm:text-sm text-gray-600 leading-relaxed">
      ...
      <p>
        SelectionSure follows a standard procedure of using log files and cookies to analyze traffic, count views on job listings, and customize advertising displays (e.g. Google AdSense).
      </p>
