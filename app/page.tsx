          ...
          <div className="bg-white border border-border-custom rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-4 bg-gray-50 border-t border-gray-100 mt-1">
              <div>
                ...
                <p className="text-xs text-gray-500">Join our WhatsApp Channel</p>
                <a
                  href="https://whatsapp.com/channel/0029VbDJYQKAInPjpaGCeb26"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 inline-flex items-center gap-1.5 bg-[#25D366] text-white text-xs font-semibold px-4 py-2 rounded-md hover:bg-[#128C7E] transition-colors"
                >
                  Join Now
                </a>
              </div>
              ...
              >
                <div className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-md hover:scale-105 transition-transform">
