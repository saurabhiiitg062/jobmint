...
export default function DisclaimerPage() {
  return (
    <div className="bg-white border border-border-custom rounded-lg p-6 md:p-8 shadow-sm space-y-6 max-w-3xl mx-auto text-xs sm:text-sm text-gray-600 leading-relaxed">
      ...
      <p>
        The content published on <strong>JobJanta.com</strong> is strictly for general informational purposes.
      </p>
      <p className="bg-red-50 p-4 border border-red-100 text-primary font-semibold rounded">
        JobJanta is not affiliated, associated, authorized, endorsed by, or in any way officially connected with any government organization, board (like SSC, UPSC, RRB), or commission.
      </p>
      <p>
