...
export default function AboutPage() {
  return (
    <div className="bg-white border border-border-custom rounded-lg p-6 md:p-8 shadow-sm space-y-6 max-w-3xl mx-auto">
      <h2 className="text-xl md:text-2xl font-bold text-secondary border-b pb-2">About JobJanta</h2>
      <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
        Welcome to <strong>JobJanta</strong>, India&apos;s leading online destination for recruitment information, admit cards, answer keys, and Sarkari Results.
      </p>
      <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
      ...
      <p className="text-xs sm:text-sm text-gray-600 leading-relaxed font-semibold">
        JobJanta is committed to speed, accuracy, and ease of access. Thank you for making us your preferred job portal.
      </p>
    </div>
  );
}
